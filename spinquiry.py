...
POSITIVE = [
    ...
    ("YES",              "YOU ALREADY KNEW — THE REELS CONFIRM IT",  "pos"),
    ("HELL YES",         "THE REELS DO NOT LIE",                     "pos"),
    ...
    ("JACKPOT",          "FIVE REELS IN AGREEMENT — UNPRECEDENTED",  "pos"),
    ("GRAND SLAM",       "BET THE HOUSE — THE ORACLE IS CERTAIN",    "pos"),
    ("GO GO GO",         "ALL FIVE REELS POINT THE SAME DIRECTION",  "pos"),
    ("WINNER",           "THE REELS HAVE BLESSED YOUR PLAN",         "pos"),
...
NEUTRAL = [
    ...
    ("UNKNOWN",          "THE REELS HAVE SEEN BOTH OUTCOMES HERE",   "neu"),
...
NEGATIVE = [
    ...
    ("NO",               "TRUST THE REELS — THEY HAVE SEEN THIS MOVIE", "neg"),
    ...
    ("CEASE",            "THE REELS HAVE SEEN THE FUTURE — ABORT",   "neg"),
    ...
    ("DANGER",           "FIVE REELS IN OPPOSITION — NOTABLE",       "neg"),
